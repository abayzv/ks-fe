        ...
        <div className="flex flex-wrap">
          <div className="w-1/3 p-2">
            <CardWidget
              ...
              count={dataAdmin?.curentTransaction}
            >
              <BiDollar size={55} />
            </CardWidget>
          </div>
          ...
          <div className="w-1/3 p-2">
            <CardWidget
              ...
              count={dataAdmin?.allTransaction}
            >
              <BsReceipt size={40} />
            </CardWidget>
          </div>
          ...
          <div className="w-3/6 p-2">
            <div className="bg-white shadow-md w-full h-72 rounded p-5">
              <div className="flex align-middle justify-between">
                ...
                <select
                  onClick={handleSelectTopCategory}
              ...
              {topCategory == "Color" && Object.keys(dataAdmin).length > 0 && (
                <Chart
              ...
              {topCategory == "Grade" && Object.keys(dataAdmin).length > 0 && (
                <Chart
              ...
              {topCategory == "Sablon" && Object.keys(dataAdmin).length > 0 && (
                <Chart
