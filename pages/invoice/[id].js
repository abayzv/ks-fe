      ...
      <Container>
        <div className="bg-white shadow-md p-2 rounded">
          ...
          <div className="p-9 border-b border-gray-200">
            ...
            <p className="text-sm"> Terimakasih sudah berbelanja di kaostory, silahkan cek tagihan kamu sebelum meninggalkan outlet. </p>
          </div>
          ...
          <div className="p-9 border-b border-t border-gray-200">
            <div className="space-y-3">
              <div className="flex justify-between">
                ...
                <p className="text-gray-500 text-sm"> Rp. {sumSubtotal(data.product).toLocaleString()} </p>
              </div>
              <div className="flex justify-between">
                <div>
                  <p className="text-gray-500 text-sm"> Diskon </p>
                </div>
                <p className="text-gray-500 text-sm"> Rp. {parseInt(data.diskon).toLocaleString()} </p>
              </div>
              <div className="flex justify-between">
                <div>
                  <p className="text-gray-500 text-sm"> Dp </p>
                </div>
                <p className="text-gray-500 text-sm"> Rp. {parseInt(data.dp).toLocaleString()} </p>
              </div>
              <div className="flex justify-between">
                <div>
                  <p className="text-gray-500 text-sm"> Total </p>
                </div>
                <p className="text-gray-500 text-sm"> Rp. {toRupiah(sumSubtotal(data.product) -parseInt(data.diskon))} </p>
              </div>
            </div>
          </div>
          <div className="p-9 border-gray-200">
            <div className="space-y-3">
              <div className="flex justify-between">
                <div>
                  <p className="font-bold text-black text-lg"> Status Pembayaran </p>
                </div>
